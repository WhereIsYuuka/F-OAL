...
if __name__ == "__main__":
    ...
    parser.add_argument('--agent', dest='agent', default='ER',
                        choices=['ER', 'EWC', 'AGEM', 'CNDPM', 'LWF', 'ICARL', 'GDUMB', 'ASER', 'SCR','FOAL','PCR','ER_DVC'],
    ...
    ########################FOAL#########################
    parser.add_argument('--projection', dest='projection', default=1000, type=int, help='Linear projection size for FOAL')
